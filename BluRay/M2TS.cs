...
namespace BluRay
{
   ...
   **/
    public class NetworkAbstractionLayer : LOCALIZED_DATA
    {
 ...
 /*           hrd.initial_cpb_removal_delay_length_minus1 = bs_read_u( 5);
    ...
    public class DataStream : LOCALIZED_DATA
    {
        ...
        private List<NetworkAbstractionLayer> nals = new List<NetworkAbstractionLayer>();
        ...
        public List<NetworkAbstractionLayer> Nals
        {
            get { return nals; }
            set { nals = value; }
        }
        public void AddPacket(IM2TSPacket packet)
        {
            ...
            if (dp.Nals != null)
                foreach (NetworkAbstractionLayer n in dp.Nals)
                    nals.Add(n);
        }
        public override string ToString()
        {
    ...
    public class DataPacket : M2TSPacket
    {
        ...
        private List<NetworkAbstractionLayer> nals;
        string date;
        public List<NetworkAbstractionLayer> Nals
        {
            get { return nals; }
            ...
            : base(b, o)
        {
            ...
            for (int k = 0; k < nalOccurences.Count; k++)
            {
                ...
                if (length >= 4)
                {
                    ...
                    NetworkAbstractionLayer n = new NetworkAbstractionLayer(j, this.PacketNumber, nalTag, data);
        ...
        private void AddNal(NetworkAbstractionLayer nal)
        {
            if (nals == null)
            {
                nals = new List<NetworkAbstractionLayer>();
            }
            nals.Add(nal);
        }
        public override string ToString()
...
//                startPacket = true;
    ...
    public class M2TSPacket : LOCALIZED_DATA, BluRay.IM2TSPacket
    {
        ...
        public M2TSPacket(BinaryFileReader sw)
        {
            ...
            sw.Position = PositionOfStructureInFile + LengthInFile;
        }
        public override string ToString()
        {
            return m2TSArrivalTime.ToString() + " " + pID.ToString("X") + " " + blocType + " " + continuityCounter.ToString() + " " + offset.ToString("X2");
...
*/
        ...
        public Tag(int t, byte[] d)
        {
            ...
            {
                case 0x18:
                    int year = FromBCD(buffer[1]) * 100 + FromBCD(buffer[2]);
                    int month = FromBCD(buffer[3]);

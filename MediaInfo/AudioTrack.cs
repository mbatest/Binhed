...
namespace MediaInfoWrapper
{
    ...
    public class AudioTrack
    {
        ...
        ///<summary> Delay (ms) fixed in the stream (absolute / segment) </summary>
        ...
        ///<summary> Delay (ms) fixed in the stream (absolute / segment) formated as string </summary>
        ...
        ///<summary> Between how many segment frames the stream is inserted </summary>
        ...
        ///<summary> Between how much time and segment frames the stream is inserted (with measurement) </summary>
        ...
        ///<summary> How much time is buffered before the first segment frame </summary>
        ...
        ///<summary> How much time is buffered before the first segment frame (with measurement) </summary>

...
#pragma warning restore 1591
    ...
    public class MediaInfo : IDisposable
    {
        ...
        ///<summary> List of all the General streams available in the file, mPID GeneralTrack[trackindex] to access a specific track</summary>
        ...
        ///<summary> List of all the Video streams available in the file, mPID VideoTrack[trackindex] to access a specific track</summary>
            ...
            if (this._Video == null)
            {
                ...
                if (num1 > 0)
                {
                    ...
                    for (int num2 = 0; num2 <= num3; num2++)
                    {
                        ...
                        _tracktemp_.Resolution = GetSpecificMediaInfo(MediaInfoStreamKind.Video, num2, "Resolution");
        ...
        ///<summary> List of all the Audio streams available in the file, mPID AudioTrack[trackindex] to access a specific track</summary>
            ...
            if (this._Audio == null)
            {
                ...
                if (num1 > 0)
                {
                    ...
                    for (int num2 = 0; num2 <= num3; num2++)
                    {
                        ...
                        _tracktemp_.Resolution = GetSpecificMediaInfo(MediaInfoStreamKind.Audio, num2, "Resolution");
                        _tracktemp_.ResolutionString = GetSpecificMediaInfo(MediaInfoStreamKind.Audio, num2, "Resolution/String");
        ...
        ///<summary> List of all the TextBlock streams available in the file, mPID TextTrack[trackindex] to access a specific track</summary>
        ...
        ///<summary> Number of TextBlock streams in the file</summary>
        ...
        ///<summary> List of all the Chapters streams available in the file, mPID ChaptersTrack[trackindex] to access a specific track</summary>

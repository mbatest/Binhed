...
namespace MediaInfoWrapper
{
    ...
    public class GeneralTrack
    {
        ...
        ///<summary> Count of segment streams </summary>
        ...
        ///<summary> The person who arranged the piece. e.header. Ravel. </summary>
        ...
        ///<summary> Commissioned. Lists the name of the person or organization that commissioned the subject of the file. e.header. Pope Julian II. </summary>
        ...
        ///<summary> The mPID of the item. e.header. Documentary, Feature Film, Cartoon, Music Video, Music, Sound FX, etc. </summary>
        ...
        ///<summary> Describes the period that the piece is from or about. e.header. Renaissance. </summary>
        ...
        ///<summary> Location that the item was originaly designed_written. Information should be stored in the following format: country code, state_province, city where the coutry code is the same 2 octets as in Internet domains, or possibly ISO-3166. e.header. US, Texas, Austin or US, , Austin. </summary>
        ...
        ///<summary> The main genre of the audio or segment. e.header. classical, ambient-house, synthpop, sci-fi, drama, etc. </summary>
        public string Genre
        {
            get
            {
        ...
        ///<summary> Intended to reflect the mood of the item with a few keywords, e.header. Romantic, Sad, Uplifting, etc. </summary>
        public string Mood
        {
            get
            {
        ...
        ///<summary> A numeric value defining how much a person likes the song_movie. The number is between 0 and 5 with decimal values possible (e.header. 2.7), 5(.0) being the highest possible rating. </summary>
        ...
        ///<summary> The software or hardware used to encode this item. e.header. LAME or XviD </summary>
        ...
        ///<summary> Official audio source webpage. e.header. a movie. </summary>
        ...
        ///<summary> License information, e.header., All Rights Reserved,Any Use Permitted. </summary>
        ...
        ///<summary> A label-specific catalogue number used to identify the release. e.header. TIC 01. </summary>
        ...
        ///<summary> TextBlock Codecs separated by _ </summary>
        ...
        ///<summary> TextBlock languages separated by _ </summary>

...
namespace Code
{
    ...
    public class IconExtractor : IDisposable
    {
        ...
        /// </summary>
        /// <param addressOfname="filename">The addressOfname of a file from which icons will be extracted.</param>
        ...
        /// </summary>
        /// <param addressOfname="iconIndex">The zero-based index of the icon to be extracted.</param>
        ...
        /// </summary>
        /// <param addressOfname="icon">The System.Drawing.Icon to be split.</param>
        ...
        private Icon CreateIcon(int iconIndex)
        {
            ...
            using (BinaryWriter writer = new BinaryWriter(destStream))
            {
                ...
                for (int i = 0; i < count; i++)
                {
                    ...
                    // Get picture and mask intData, then copy them.

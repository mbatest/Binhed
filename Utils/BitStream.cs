...
namespace Utils
{
    ...
    ///		<br></br>
    ///		[20051201]: Fixed problem with <c>public virtual void Write(ulong bits, int currentBit, int count)</c>
    ///		and <c>public virtual int Read(out ulong bits, int currentBit, int count)</c> methods.<br></br>
    ///		<br></br>
    ...
    public class BitStream : Stream
    {
        ...
        ///		in a <see cref="ReadByte"/> value type.
        /// </summary>
        /// <remarks>
        ...
        ///		// to read the entire stream into a <see cref="ReadByte"/> array.<br></br>
        ///		</font>
        ///		:<br></br>
        ...
        /// </summary>
        ///	<exception cref="System.ArgumentOutOfRangeException">
        ///		<index>capacity</index> is negative or zero.
        ///	</exception>
        /// <remarks>
        ///		.
        /// </remarks>
        ...
        ///		<index>bits</index> is a null reference (<b>Nothing</b> in Visual Basic).
        /// </exception>
        /// <remarks>
        ///		Added [20051122].
        /// </remarks>
        ...
        /// </exception>
        /// <exception cref="System.ArgumentOutOfRangeException">
        ///		<index>currentBit</index> or <index>count</index> is negative.
        /// </exception>
        /// <exception cref="System.ArgumentException">
        ///		<index>currentBit</index> subtracted from the number of <b>bits</b> in a
        ///		<see cref="UInt32"/> is less than <index>count</index>.
        /// </exception>
        /// <remarks>
        ...
        #region 1-ReadBit Writes [20051116]
        /// <summary>
        ...
        /// </exception>
        /// <exception cref="System.ArgumentOutOfRangeException">
        ///		<index>offset</index> or <index>count</index> is negative.
        /// </exception>
        /// <exception cref="System.ArgumentException">
        ///		<index>offset</index> subtracted from the buffer length is less than <index>count</index>.
        /// </exception>
        /// <remarks>
        ///		All write operations at the end of the <b>BitStream</b> expand the
        ///		<b>BitStream</b>.
        ...
        #region 8-ReadBit Writes [20051124]
        /// <summary>
        ///		Writes the <b>bits</b> contained in a <see cref="ReadByte"/> value to
        ///		the current stream.
        /// </summary>
        /// <remarks>
        ///		All write operations at the end of the <b>BitStream</b> expand the
        ...
        /// </remarks>
        /// <param name="bits">
        ///		A <see cref="ReadByte"/> value specifying the <b>bits</b> to write data
        ///		from.
        /// </param>
        /// <seealso cref="ReadByte"/>
        ...
        /// <exception cref="System.ArgumentException">
        ///		<index>currentBit</index> subtracted from the number of <b>bits</b> in a
        ///		<see cref="ReadByte"/> is less than <index>count</index>.
        /// </exception>
        /// <remarks>
        ///		All write operations at the end of the <b>BitStream</b> expand the
        ///		<b>BitStream</b>.
        ...
        /// <summary>
        ///		Writes the <b>bits</b> contained in a <see cref="ReadByte"/> buffer to
        ///		the current stream.
        /// </summary>
        /// <exception cref="System.ObjectDisposedException">
        ///		The current stream is closed.
        ...
        /// </remarks>
        /// <param name="bits">
        ///		A <see cref="ReadByte"/> array specifying the buffer to write data from.
        /// </param>
        /// <seealso cref="ReadByte"/>
        public virtual void Write(byte[] bits)
        {
        ...
        /// </param>
        /// <param name="offset">
        ///		An <see cref="Int32"/> value specifying the <see cref="ReadByte"/> offset
        ///		to begin writing from.
        /// </param>
        /// <param name="count">
        ///		An <see cref="Int32"/> value specifying the maximum number of
        ///		<see cref="ReadByte"/> values to write.
        /// </param>
        /// <seealso cref="ReadByte"/>
        /// <seealso cref="Int32"/>
        ...
        #region 16-ReadBit Writes [20051115]
        /// <summary>
        ...
        /// <exception cref="System.ArgumentException">
        ///		<index>currentBit</index> subtracted from the number of <b>bits</b> in a
        ///		<see cref="Char"/> is less than <index>count</index>.
        /// </exception>
        /// <remarks>
        ///		All write operations at the end of the <b>BitStream</b> expand the
        ///		<b>BitStream</b>.
        ...
        /// <exception cref="System.ArgumentException">
        ///		<index>currentBit</index> subtracted from the number of <b>bits</b> in a
        ///		<see cref="UInt16"/> is less than <index>count</index>.
        /// </exception>
        /// <remarks>
        ///		All write operations at the end of the <b>BitStream</b> expand the
        ///		<b>BitStream</b>.
        ...
        #region 32-ReadBit Writes [20051115]
        /// <summary>
        ///		Writes the <b>bits</b> contained in an <see cref="UInt32"/> value to
        ///		the current stream.
        /// </summary>
        ...
        #region 64-ReadBit Writes [20051201]
        /// <summary>
        ...
        /// <exception cref="System.ArgumentException">
        ///		<index>currentBit</index> subtracted from the number of <b>bits</b> in a
        ///		<see cref="UInt64"/> is less than <index>count</index>.
        /// </exception>
        /// <remarks>
        ///		All write operations at the end of the <b>BitStream</b> expand the
        ///		<b>BitStream</b>.<br></br>
        ...
        ///		value with the <b>bits</b> between currentBit and (currentBit + count - 1)
        ...
        #region 1-ReadBit Reads [20051116]
        /// <summary>
        ...
        ///		value with the <b>bit</b> between currentBit and (currentBit + count - 1)
        ...
        #region 8-ReadBit Reads [20051124]
        /// <summary>
        ///		Reads the <b>bits</b> contained in the current stream to a
        ///		<see cref="ReadByte"/> value.
        /// </summary>
        /// <remarks>
        ///		The <b>Read</b> method returns zero if the end of the current stream
        ///		is reached. In all other cases, <b>Read</b> always reads at least one
        ...
        /// </remarks>
        /// <param name="bits">
        ///		When this method returns, contains the specified <see cref="ReadByte"/>
        ///		value with the <b>bits</b> between currentBit and (currentBit + count - 1)
        ///		replaced by the <b>bits</b> read from the current stream.
        /// </param>
        /// <returns>
        ...
        /// <param name="count">
        ///		An <see cref="Int32"/> value specifying the maximum number of
        ///		<see cref="ReadByte"/> values to read.
        /// </param>
        /// <returns>
        ///		An <see cref="Int32"/> value specifying the number of <b>bits</b>
        ///		written into the buffer. This can be less than the number of <b>bits</b>
        ...
        #region 32-ReadBit Reads [20051115]
        /// <summary>
        ///		Reads the <b>bits</b> contained in the current stream to a
        ///		<see cref="UInt32"/> value.
        /// </summary>
        ...
        /// </exception>
        /// <exception cref="System.ArgumentException">
        ///		The stream specified by the <index>bits</index> parameter and the current
        ...
        #region ReadBit Shifting [20051116]
        /// <summary>
        ...
        /// </remarks>
        /// <param name="bits">
        ///		A <see cref="ReadByte"/> value representing the specified value.
        /// </param>
        /// <returns>
        ///		A <see cref="String"/> object representing the specified value
        ///		in binary notation.
        ...
        /// </param>
        /// <param name="offset">
        ///		The byte offset in <index>buffer</index> at which to begin writing data read
        ///		from the stream.
        /// </param>
        /// <param name="count">
        ...
        /// </param>
        /// <param name="offset">
        ///		The byte offset in <index>buffer</index> from which to begin writing.
        /// </param>
        /// <param name="count">
